...
<script>
import IdentityCardsPaymentsService from '@/services/IdentityCardsPaymentsService.js';
import {
    required,
    minLength,
    maxLength,
...
export default {
    data() {
        return {
            ...
            actionTypeOptions: [
                {
                    id: 1,
                    text: 'Pasaport electronic(sub 12 ani)',
                    value: 1,
                },
                {
                    id: 2,
                    text: 'Pasaport electronic(peste 12 ani)',
                    value: 2,
                },
                {
                    id: 3,
                    text: 'Pasaport temporar(toate varstele)',
                    value: 3,
                },
            ],
        };
    ...
    methods: {
        async pay() {
            ...
            this.backendResponse = await IdentityCardsPaymentsService.payPassportTax(
                formCopy
            );
        },
        exportPDF() {
            IdentityCardsPaymentsService.generatePDFforPassportTax(this.form);
        },
    },
    ...
    computed: {
        total() {
            ...
            if (this.form.actionType.value === 3) {
                return 96;
            }
